"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Ab:function(){return sO},ET:function(){return sR},IO:function(){return sh},JU:function(){return iM},PL:function(){return sk},QT:function(){return sS},Xo:function(){return sm},ad:function(){return iU},b9:function(){return sg},cf:function(){return sx},hJ:function(){return iV},nP:function(){return sF},pl:function(){return sb},r7:function(){return sD},vr:function(){return sM}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class si{constructor(e,t,n,r,i){this._firestore=e,this._userDataWriter=t,this._key=n,this._document=r,this._converter=i}get id(){return this._key.path.lastSegment()}get ref(){return new ix(this._firestore,this._converter,this._key)}exists(){return null!==this._document}data(){if(this._document){if(this._converter){let e=new ss(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){let t=this._document.data.field(sa("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}class ss extends si{data(){return super.data()}}function sa(e,t){return"string"==typeof t?st(e,t):t instanceof i$?t._internalPath:t._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sS(e){e=ik(e,ix);let t=ik(e.firestore,iP);return(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ip({next:o=>{s.Za(),t.enqueueAndForget(()=>r$(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rG(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rB(e,a)})(await iE(e),e.asyncQueue,t,n,r)),r.promise})(iq(t),e._key).then(n=>sV(t,e,n))}class sN extends s_{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ix(this.firestore,null,t)}}function sk(e){e=ik(e,iR);let t=ik(e.firestore,iP),n=iq(t),r=new sN(t);return so(e._query),(function(e,t,n={}){let r=new S;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ip({next:n=>{s.Za(),t.enqueueAndForget(()=>r$(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rG(n,s,{includeMetadataChanges:!0,_a:!0});return rB(e,a)})(await iE(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sA(t,r,e,n))}function sb(e,t,n){e=ik(e,ix);let r=ik(e.firestore,iP),i=sE(e.converter,t,n);return sL(r,[iZ(iJ(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tV.none())])}function sD(e,t,n,...r){e=ik(e,ix);let i=ik(e.firestore,iP),s=iJ(i);return sL(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof i$?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i7(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i7(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!sr(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof i0)u.push(t);else{let e=i9(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iW(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i6("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=st(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof i0)s.push(o);else{let e=i9(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iW(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tV.exists(!0))])}function sR(e,t){let n=ik(e.firestore,iP),r=iM(e),i=sE(e.converter,t);return sL(n,[iZ(iJ(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tV.exists(!1))]).then(()=>r)}function sx(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iF(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iF(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof ix)a=ik(e.firestore,iP),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sV(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=ik(e,iR);a=ik(n.firestore,iP),o=n._query;let r=new sN(a);s={next:e=>{t[u]&&t[u](new sA(a,r,n,e))},error:t[u+1],complete:t[u+2]},so(e._query)}return function(e,t,n,r){let i=new ip(r),s=new rG(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rB(await iE(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>r$(await iE(e),s))}}(iq(a),o,c,s)}function sL(e,t){return function(e,t){let n=new S;return e.asyncQueue.enqueueAndForget(async()=>r9(await i_(e).then(e=>e.syncEngine),t,n)),n.promise}(iq(e),t)}function sV(e,t,n){let r=n.docs.get(t._key),i=new sN(e);return new sI(e,i,t._key,r,new sT(n.hasPendingWrites,n.fromCache),t.converter)}function sM(...e){return new i2("arrayUnion",e)}function sO(...e){return new i3("arrayRemove",e)}function sF(e){return new i4("increment",e)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iP(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);